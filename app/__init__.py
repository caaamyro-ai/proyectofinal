...
from flask_migrate import Migrate #***NUEVO: LO AGREGUÉ PARA MIGRACIONES*****

# Crear primero la instancia global de la base de datos
db = SQLAlchemy()
migrate = Migrate() # ***NUEVO: LO AGREGUÉ PARA MIGRACIONES*****
def create_app():
    app = Flask(__name__)
 ...
 # Inicializar Flask-Migrate
    migrate.init_app(app, db)   # ***NUEVO PARA MIGRACIONES ****
